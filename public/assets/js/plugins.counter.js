...
SEMICOLON.widget.counterInit = function( $counterEl ){
			...
			let observer = new IntersectionObserver( function(entries, observer) {
				entries.forEach( function(entry) {
					if (entry.isIntersecting) {
						SEMICOLON.widget.runCounterInit( element, elCommaObj );
...
SEMICOLON.widget.runCounterInit = function( elCounter, elFormat ){
