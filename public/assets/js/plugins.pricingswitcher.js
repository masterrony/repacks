...
SEMICOLON.widget.pricingSwitcherFn = function( checkbox, parent, pricing, defClass, actClass ) {
...
SEMICOLON.widget.pricingSwitcherInit = function( $pricingSwitcherEl ){
	...
	$pricingSwitcherEl.each( function(){
		...
		SEMICOLON.widget.pricingSwitcherFn( elCheck, elParent, elPricing, elDefClass, elActClass );
